...
for($havepassanger=1; $havepassanger <= $queuntity; $havepassanger++)
{
	   ...
	   $table = $wpdb->prefix.'customer_schedule_booking';
		...
		//$format = array('%s');
		 ...
		 $palceorderapi='http://schedulebull.com/api3.php?place_from='.$varFromLocation.'&place_to='.$varToLocation.'&from='.$dateOutbound.'&till='.$tilldate.'&agency=Website&client='.$Customerfirstname.'&flightNr='.$flightarrivaltime.'&comment='.$comment.'&telnr='.$customermobilephone.'&price='.$reservePriceMain.'&passengers='.$fromPaSSenger.'&q=transphere/shedule/save&key='.$getApikey.'';
		// echo $palceorderapi;
      ...
      for($havepassanger=1; $havepassanger <= $queuntity; $havepassanger++)
{
	   ...
	   $table = $wpdb->prefix.'customer_schedule_booking';
		...
		//$format = array('%s');
		 ...
		 $palceorderapi1='http://schedulebull.com/api3.php?place_from='.$varToLocation.'&place_to='.$varFromLocation.'&from='.$returnDate.'&till='.$tillreturndate.'&agency=Website&client='.$Customerfirstname.'&flightNr='.$flightDeparturetime.'&comment='.$comment.'&telnr='.$customermobilephone.'&price='.$TOPassengerMain.'&passengers='.$TOPassenger.'&q=transphere/shedule/save&key='.$getApikey.'';
		 //echo $palceorderapi1;
...
$message .= "<tr><td><strong>Time:</strong> </td><td>" . date("h:i", strtotime($dateOutbound)) . "</td></tr>";
if(!empty($returnDate)){
...
$message .= "<tr><td><strong>Return time:</strong> </td><td>" . date("h:i", strtotime($returnDate)). "</td></tr>";
...
$message .= "<tr><td><strong>Do you required child seats?:</strong> </td><td>" . $childseats. "</td></tr>";
                        ...
                        <ul class="list-style9 no-margin">
                            ...
                            <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-7">
                                        <p><?php echo date('j M Y g:ia' ,strtotime($Outbound)); ?></p>
                                    </div>
                                </div>
							...
							<?php if(!empty($returnDate)){?>
							  <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-7">
                                        <p><?php  echo date('j M Y g:ia' ,strtotime($returnDate));?></p>
                                    </div>
                                </div>
...
<div class="col-6 second-form-inpu"> 
	...
	<optgroup label="Other countries">
 	...
 	<div class="row details-passenger">
       	...
       	<div class="col-4 second-form-inpu">
       		<div class="p-0  my-3">
         	<input type="text" name="Child_seats" class="form-control rounded-0" placeholder="Child seats">
         	<p class="text-dark py-2">Childs weight 9-18kg (1-4 years)</p>
         </div>
       	</div>
       	<div class="col-4 second-form-inpu">
       		<div class=" p-0  my-3">
         	<input type="text" name="child_seats" class="form-control rounded-0" placeholder="Booster seats">
