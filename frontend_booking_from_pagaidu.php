...
if(isset($_POST['ordersubmit'])){
	...
	$comment = 'Email:'.$customeremail.'| 2nd mobile:'.$moible_number2.'| Luggage info:'.$luggageinfo.'| Oversize luggage info:'.$oversizedluggage.'| Payment via Stripe:'.$paymentviastripe.'| Remaining balance:'.$payremainingbalance.'| Infant seats:'.$childseats.'| Child seats:'.$childseats2.'| Booster seats:'.$childseats3.'| Address:'.$hotelnameaddress.'| Notes:'.$additionalnote;
